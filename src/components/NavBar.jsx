...
const NavBar = () => {
  ...
  return (
    <div className="min-w-[120px] border-e border-gray-300 flex flex-col items-center justify-between min-h-screen bg-white flex-grow">
      <div className="flex flex-col flex-grow items-center">
        <img
          src={logo}
          alt="logo"
          className="w-14 h-14 mb-10 mt-2 cursor-pointer"
          onClick={() => navigate("/")}
        />
        <div
      ...
      <div className="flex justify-center items-center flex-col mb-2 cursor-pointer">
        ...
        <p className="opacity-85 font-sans" onClick={handleLogout}>
          Logout
        </p>
      </div>
    </div>
